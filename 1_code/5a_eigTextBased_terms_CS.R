...
# RMSE
RMSE1 <- sqrt(sum( (text$dT_ia - text$EIGtext)^2 )) / sqrt(sum( (text$dT_ia - text$EIGhmxz)^2 ))
test1 <- t.test( (text$dT_ia - text$EIGtext)^2, (text$dT_ia - text$EIGhmxz)^2)
RMSE1;test1
...
# RMSE
RMSE2 <- sqrt(sum( (text$dT_ia.x - text$EIGtext)^2 )) / sqrt(sum( (text$dT_ia.y - text$EIGhmxz)^2 ))
test2 <- t.test( (text$dT_ia.x - text$EIGtext)^2, (text$dT_ia.y - text$EIGhmxz)^2)
RMSE2;test2
...
# RMSE
RMSE3 <- sqrt(sum( (text$dT_ia.x - text$EIGtext)^2 )) / sqrt(sum( (text$dT_ia.y - text$EIGhmxz)^2 ))
test3 <- t.test( (text$dT_ia.x - text$EIGtext)^2, (text$dT_ia.y - text$EIGhmxz)^2)
RMSE3;test3
